...
Except for the Risk Treasury, all of our treasuries hold either stablecoins and/or yield bearing assets based on stablecoins. At launch we will use USDC exclusively and as
such we'll be talking about USDC throughout the rest of the docs.
